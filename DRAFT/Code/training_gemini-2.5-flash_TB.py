...
TUNED_MODEL_DISPLAY_NAME=f"{BASE_MODEL}-TB-tuned-draft"

TRAINING_URI = f"gs://{BUCKET_NAME}/datasets-draft/TBtrain.jsonl"
VALIDATION_URI = f"gs://{BUCKET_NAME}/datasets-draft/TBval.jsonl"
