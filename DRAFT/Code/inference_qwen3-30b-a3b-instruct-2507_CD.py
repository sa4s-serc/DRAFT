...
checkpoint_path = os.getenv("CHECKPOINT_PATH", "DRAFT/Output/checkpoint-380")  # set via env or hardcode
...
output_file = "DRAFT/Results/qwen3-30b-a3b-instruct-CDtest.jsonl"
