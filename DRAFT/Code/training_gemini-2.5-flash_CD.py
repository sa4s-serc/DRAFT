...
TUNED_MODEL_DISPLAY_NAME=f"{BASE_MODEL}-CD-tuned-draft"

TRAINING_URI = f"gs://{BUCKET_NAME}/datasets-draft/CDtrain.jsonl"
VALIDATION_URI = f"gs://{BUCKET_NAME}/datasets-draft/CDval.jsonl"
