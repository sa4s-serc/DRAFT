...
tokenizer = AutoTokenizer.from_pretrained(model_name, cache_dir="../cache", token=HUGGINGFACE_TOKEN)
model = AutoModelForCausalLM.from_pretrained(model_name, cache_dir="../cache", token=HUGGINGFACE_TOKEN, device_map="auto")
