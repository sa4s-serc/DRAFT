...
# load a local checkpoint instead of the remote pretrained model
checkpoint_path = os.getenv("CHECKPOINT_PATH", "Finetune/Output/checkpoint-760")  # set via env or hardcode
...
output_file = "Finetune/Results/qwen3-30b-a3b-instruct-CDtest.jsonl"
